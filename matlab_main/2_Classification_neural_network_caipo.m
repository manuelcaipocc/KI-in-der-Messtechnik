...
fprintf("Input (Original) | Erwartet | Vorhergesagt\n");
fprintf("------------------------------------------\n");
...
for i = 1:size(X_test_neu,1)
    x = (X_test_neu(i,:) - X_min) ./ (X_max - X_min + eps);  % Normalisierung
    ...
    % Mostrar los valores
    fprintf("[%3d %3d %3d]   |    %d     |    %d", ...
            X_test_neu(i,1), X_test_neu(i,2), X_test_neu(i,3), ...
            Y_erwartet(i), k);
